...
element.classList.add("active");
    var col = document.getElementById("collapse-ecommerce");  //expand collasped menu
col.classList.add("show");
    var ecommerce = document.getElementById("ecommerce");  //toggle collasped mega menu
ecommerce.classList.remove("collapsed");
</script>
 ...
 /* if (str=="") {
  ...
  xmlhttp.onreadystatechange=function() {
    if (this.readyState==4 && this.status==200) {
      document.getElementById("e-commerce-products-table").innerHTML=this.responseText;
         // $("#txtHint").html(str);
...
//document.getElementById("txtHint").innerHTML=this.responseText;
         // $("#txtHint").html(str);
  xmlhttp.open("GET","phpd?q="+str,true);
  xmlhttp.send();
}
</script>
                                ...
                                <div class="col-12 col-sm">
                                    ...
                                    <div class="logo row no-gutters align-items-start">
                                        ...
                                        <div class="logo-text">
                                            ...
                                            <div class="" role="status" id="e-commerce-products-table_info">Total Products:<?php
                                              echo  $_SESSION['total'];
                                                ?></div>
                                        </div>
                                    </div>
				...
				echo'
                                        <tr>
                                            ...
                                            <td>
	                                           ...
	                                           <td>                                 
                                               <button onclick="deleteitem(this.value)" class="" name="deleteitem" value="'.$q.'" type="button" class="btn btn-icon" aria-label="Product details">
                                                    
                                                      <i class="text-danger icon icon-close s-4"></i>
                                                </button>
                                            </td>
