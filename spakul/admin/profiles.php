...
<div class="container">
	...
	<div class="page-header">
    	<h5 class="h2"><?php echo $_SESSION['vendor_session']; ?><a class="btn btn-default" href="addnew.php"> <span class="glyphicon glyphicon-plus"></span> &nbsp; add new </a></h5> 
    </div>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<div class="col-xs-3">
				...
				<p class="page-header">
				<span>
				<a class="btn btn-info" href="editprofile.php?edit_id=<?php echo $row['userID']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
