...
<nav class="navbar clearHeader">
    <div class="container-fluid">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a>  <a class="navbar-brand" href="index-2.html"></a> </div>
        ...
        <div class="user-info">
            ...
            <div class="admin-action-info"> <span>Welcome</span>
                ...
                <ul>
                    ...
                    <li><a data-placement="bottom" title="Sign Out" href="logout" ><i class="zmdi zmdi-sign-in"></i></a></li>
                    <li><a href="javascript:void(0);" class="js-right-sidebar" data-close="true"><i class="zmdi zmdi-settings"></i></a></li>                   
                </ul>
            </div>
            <div class="quick-stats">
                <h5>Today Report</h5>
                <ul>
				<li><img width="54px" alt="eCommerce" src="http://localhost/spakul-main1/img/spakul.png"></li>
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li  class="active open"><a href="home"><i class="zmdi zmdi-home"></i><span>Dashboard</span> </a> </li>
				   <li> <a href="product"><i class="zmdi zmdi-chart-donut col-red"></i><span>Product 		</span> </a> </li>
