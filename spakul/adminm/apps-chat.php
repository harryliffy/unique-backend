...
$last=$n['last_activity'];
$send=$_SESSION['logged_as'];
//echo 'last seen:'.$last ;
//$count=mysql_query("SELECT last_activity FROM fbchat_users where last_activity BETWEEN $last AND $nnow");
 
$result=mysql_query("SELECT * FROM `fbchat_chats` where sender !='$send' and date between '$last' and '$nnow' ");	
//echo $count;// echo 'sd';
//echo $last;
...
<!-- Mirrored from fuse-bootstrap4-material.withinpixels.com/vertical-layout-below-toolbar-left-navigation/apps-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Jul 2017 09:20:39 GMT -->
</html>