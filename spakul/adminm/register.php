...
-    <body class="layout layout-vertical layout-left-navigation layout-below-toolbar">
        ...
        <div id="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <div id="register" class="p-8"style="margin-top:-60px;" ><!----forced style to make image begin from top------>
                        ...
                        <div class="form-wrapper md-elevation-8 p-8">
                            ...
                            <form name="registerForm" method="post" id="acc-form" novalidate>
     <div id="error">
        <!-- error will be shown here ! -->
                            ...
                            <div
                                ...
                                <a class="link text-primary" href="login">Log in</a>
                            </div>
...
<!-- Mirrored from fuse-bootstrap4-material.withinpixels.com/vertical-layout-below-toolbar-left-navigation/pages-auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Jul 2017 09:20:39 GMT -->
</html>