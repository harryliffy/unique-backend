...
<!-- Icons.css -->
    ...
    <body class="layout layout-vertical layout-left-navigation layout-below-toolbar">
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                                ...
                                <ul id="collapse-dashboards"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple " href="apps-dashboards-project.html"
                                           data-page-url="/pages-auth-login.html">
                            ...
                            <li class="nav-item" role="tab" id="heading-authentication">
                                ...
                                <ul id="collapse-authentication"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple active" href="pages-auth-login.html"
                                           data-page-url="/pages-auth-login.html">
            ...
            <div class="content-wrapper">
                ...
                <nav id="" class="fixed-top bg-white" style="height:1px !important; visibility:hidden;">
                ...
                <div class="content">
                    <div id="login" class="p-8" style="margin-top:-60px;" ><!----forced style to make image begin from top------>
       ...
       <form class="form-signin" method="post" id="login-form">
        ...
        <input type="email" class="form-control" placeholder="Email address" name="user_email" id="user_email" aria-describedby="emailHelp" placeholder=" "/> <label for="loginFormInputEmail">Email address</label>
        <span id="check-e"></span>
        </div>
		
        
        <div class="form-group">
        <input type="password" class="form-control" placeholder="Password" name="password" id="password" placeholder="Password"/>
        ...
        <div class="form-group">
            <button type="submit" class="submit-button btn btn-block btn-primary my-4 mx-auto" name="btn-login" id="btn-login">
 ...
 <div class="separator">
                            ...
                            <button type="submit" class="google btn btn-block btn-primary my-2 mx-auto"
                                    aria-label="LOG IN">
                <span>
                    ...
                    <span>Log in with Google</span>
                            ...
                            <button type="submit" class="facebook btn btn-block btn-primary my-2 mx-auto"
                                    aria-label="LOG IN">
                <span>
