              ...
              <div class="product-essential">
                <form action="#" method="post" id="product">
                  ...
                  <div class="product-shop col-lg-7 col-sm-6 col-xs-12">
					...
					try{
$navid = $_GET['EsW2k'];
$stmt = $db_con->prepare("SELECT * FROM product WHERE itemcode=:itemcode");
$stmt->execute(array(":itemcode"=>$navid));
$row=$stmt->fetch(PDO::FETCH_ASSOC);
				$proname=$row['prod_name'];
				$price=$row['price'];
				echo $price;
			...
			echo $e->getMessage();
                    ...
                    <div class="price-block">
                      <div class="price-box">
                        <p class="special-price"> <span class="price-label">Special Price</span> <span id="product-price-48" class="price"> NGN<?phpecho $price; ?> </span> </p>
                    ...
                    <div class="form-option">
                      ...
                      <div class="add-to-box">
                        <div class="add-to-cart">
						  ...
						  <!--button type="button" class="mini-cart basket button btn-cart " data-toggle="modal"
															data-target="#gridSystemModal">
														Request quoted
													</button--> 
													<button type="button" class="mini-cart basket button btn-cart" name="btn-login" id="btn-login">
														<span class="glyphicon glyphicon-log-in"></span>Request quote
													</button>
                        </div>
        ...
        <!-- error will be shown here ! -->
			 ...
			 <!--div class="col-sm-4">
                  ...
                  <label for="Last Name">Full Name<span class="required"></span></label>
                  <br>
                  <input type="text" title="Full Name" id="Lname" class="form-control input-text required-entry validate-password" placeholder="Full Name" name="Lname"/>
					</div>
                    <!--/ [col] -->
				     </li>
					  <li class="row">
			 <div class="col-sm-6">
                  ...
                  <br>
                  <input type="phone" title="phone" id="Phone" class="form-control input-text required-entry validate-password" placeholder="phone" name="phone"/>
			 ...
			 <div class="col-sm-6">
                  ...
                  <br>
                  <input type="Email" title="Email" id="email" class="form-control input-text required-entry validate-password" placeholder="Email" name="email" />
				  </div>
                    <!--/ [col] -->
				     </li>
			 ...
			 <div class="col-sm-6">
                  ...
                  <br>
                  <input type="password" title="password" id="password" class="form-control input-text required-entry validate-password" placeholder="*********" name="password"/>
					...
					<!--li class="row">
			 <div class="col-sm-6">
                  <label for="pass">location <span class="required"></span></label>
                  <br>
                  <input type="password" title="location" id="pass" class="form-control input-text required-entry validate-password" placeholder="location" name="password" id="password"/>
				  </div>
                    <!--/ [col] -- >
				     </li-->
            ...
            <br>	
                ...
                <!--button onclick="window.location='http://demo.magentojtv.com/computerstore/customer/account/create/';" class="button create-account" type="button"><span>Create an Account</span></button-->
				 ...
				 <button type="submit" class="btn btn-default button create-account" name="btn-login" id="btn-login">
