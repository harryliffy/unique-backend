 ...
 <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
    ...
    <ul class="breadcrumb">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <div id="preview"><img width="200px" src="no-image.jpg" /></div>
                        <!--p  class="statusMsg"></p-->
                        <form id="form" action="testupload.php" method="post" enctype="multipart/form-data">
                            <!--form enctype="multipart/form-data" id="fupForm" class="form-horizontal"-->
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <button type="submit" name="button" id="button" type="submit"  class="btn btn-primary pull-right"><span class="glyphicon glyphicon-save"></span>  Submit</button>
