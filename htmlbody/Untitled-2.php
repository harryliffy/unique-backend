                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        ...
                        <!--p  class="statusMsg"></p-->
                            ...
                            <form enctype="multipart/form-data" id="form" action="edit-event-process.php" method="post" class="form-horizontal">
                            <div class="panel panel-default">
                                
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit</strong> Event</h3>
                                    <ul class="panel-controls">
                                        <li><a href="events" class="panel-remove"><span class="fa fa-times"></span></a></li>
                                    </ul>
                                </div>
                              ...
                              <div class="panel-body">                                                                        <?php 
                               ...
                               extract($row);
                               echo $row['event_name'];
                              //$user-> fetchEditEvent('event_name');
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-6 col-xs-12">                                            
                                      <div class="input-group">
                                          ...
                                          <input name="event_title" id="event_title" type="text" class="form-control" value="'.$row['event_name'].'"/>
                                          <input type="hidden" value="'.$row['event_image'].'" name="currentimage"  id="currentimage" />
                                  <input type="hidden" value="'.$row['event_id'].'" name="currentid"  id="currentid" />    </div>                                            
                          ...
                          <div class="panel-footer">
                              <a href="events " id="close" class="btn btn-default">Back</a>                                    
