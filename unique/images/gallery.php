...
<head>
  ...
  <title>Unique Blossom  | Schools</title>
	<!-- Latest compiled and minified CSS -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js" type="text/javascript"></script>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link href="harrylifford.com/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
    <link rel='stylesheet prefetch' href='https://harrylifford.com/css/bootstrap.min.css'>
 ...
 <link rel="icon" type="image/png" href="images/logo.png"> 
	...
	<style>
	  ...
	  .tabs a:hover,
	  .tabs a.active {
	  /*	background: linear-gradient(to bottom, rgb(138, 138, 170) 30%,rgb(247, 247, 247) 100%);*/
	  background: #bdc9d7;
	  }
	  .tabgroup div {
		padding: 3px;
	...
	<body>
		<header id="masthead" class="site-header container">
			<div class="row">
				<div class="site-branding col-sm-3 col-md-3">
						<h1 class="site-title">
								<a href="index" title="UBS" rel="home">
			...
			<div class="container">
				<div class="hero-content">						
					<div class="hero-caption">
						<h2>Gallery UBS</h2>
						<p>A picture holds a thousand words<br> The story told over time   </p>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="container">
						<div class="wrapper">
							  ...
							  <ul class="tabs clearfix" data-tabgroup="first-tab-group">
								...
								<li><a href="#tab2">Sports</a></li>
								<li><a href="#tab3">Labouratory</a></li>
								<li><a href="#tab4">Music</a></li>
								<li><a href="#tab5">Excursion</a></li>
							  </ul>
							  <section id="first-tab-group" class="tabgroup">
								...
								<div class="slideshow">
										...
										<img class="img-responsive" src="images/slider7.png" alt="Second Slide">
										<div class="container">
										<div class="carousel-caption"> 
										<!--h1>SlideShow 2</h1-->
										</div>
										...
										<div class="item">
											<div class="hero-3"></div>
										<img class="img-responsive" src="images/slider6.png" alt="Second Slide">
										<div class="container">
										<div class="carousel-caption"> 
										<!--h1>SlideShow 2</h1-->
										</div>
										...
										<!--h1>SlideShow 3</h1-->
											...
											<div class="item"> <!-- /. Item -->
										<img class="img-responsive" src="images/slider5.png" alt="Third slide">
										<div class="container">
										<div class="carousel-caption">
										<!--h1>SlideShow 3</h1-->
										</div>
										...
										<div class="col-sm-5">
												<a href="#" data-featherlight="#content-1">
													<img src="images/gallery-list-img-2.jpg" alt="image">
												</a>
									...
									<div class="col-sm-7">
												<a href="#" data-featherlight="#content-7">
													<img src="images/gallery-list-img-7.jpg" alt="image">
												</a>
								...
								<div id="tab2">
										<div class="col-sm-5">
												<a href="#" data-featherlight="#content-9">
													<img src="images/gallery-list-img-9.jpg" alt="image">
												</a>
								...
								<div id="tab3">
										<div class="col-sm-5">
												<a href="#" data-featherlight="#content-6">
													<img src="images/gallery-list-img-3.jpg" alt="image">
												</a>
						...
						<div class="col-sm-4">
							<a href="#" data-featherlight="#content-6">
								<img src="images/gallery-list-img-6.jpg" alt="image">
							</a>
							<div id="content-6" class="gallery-lightbox">
								<img src="images/gallery-list-img-6.jpg" alt="image">
								<div class="gallery-lightbox-content">
		...
		<footer id="colophon" class="site-footer">
			...
			<div class="footer-copyright">
				<div class="container">
					<div class="row">
					<p>Copyright 2017 Harry Lifford | All rights reserved</p>
					</div>
				</div>
			</div>
		</footer>
  ...
  $('.tabs a').click(function(e){
	e.preventDefault();
	  ...
	  $(target).show();
		  ...
		  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
<script src='https://harrylifford.com/js/bootstrap.min.js'></script>
